# ⚙️ Requisitos Funcionales - Marketplace de Mascotas

Los requisitos funcionales detallan lo que el sistema debe hacer para satisfacer las necesidades de los usuarios expresadas en las historias de usuario.

## 1. Listado de Requisitos Funcionales
